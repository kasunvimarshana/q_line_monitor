<?php
require_once(VAR_BASE_DIR.DS."controller".DS."deviceEditController.php");
?>
...
<form method="POST" action="<?php echo $_SERVER["PHP_SELF"]."?".VAR_PAGE_ARG."=".VAR_CON_DEVICE_EDIT; ?>" enctype="multipart/form-data" autocomplete="off">
    <!-- form-control div -->
    ...
    <!-- -->
        <!-- id -->
        <input type="hidden" name="id" id="id" value="<?php echo $device->__get("id"); ?>" required/>
        <!-- device id -->
