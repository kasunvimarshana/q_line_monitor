<?php
require_once(VAR_BASE_DIR.DS."controller".DS."sys_userAddController.php");
?>
        ...
        <div class="row">
            ...
            <div class="box box-solid">
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title">System User Add</h3>
...
<form method="POST" action="<?php echo $_SERVER["PHP_SELF"]."?".VAR_PAGE_ARG."=".VAR_CON_SYSUSER_ADD; ?>" enctype="multipart/form-data" autocomplete="off">
    <!-- form-control div -->
